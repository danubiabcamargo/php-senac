...
if($numero <= 1){
    ...
    // verifica se o numero é divisivel por algum numero entre 2 e a raiz quadrada do proprio numero
    for($i = 2; $i <= sqrt($numero); $i++){
    if($numero % $i == 0){
        return false; // se for divisivel, nao e primo
     }
    
      }
    return true; // se nao for divisivel, é primo
}

echo "Números primos no intervalor de $numeroN até $numeroM: ";
